...
export default function EditSpending({spending}){
    const form = useForm({
        ...spending,
    ...
    function submit(e){
        e.preventDefault();
        form.put(`/edit/spending/${spending.id}`);
    }

    return(
        <AuthenticatedLayout>
            <Head title="Edit Spending" />
            <div className="py-16">
                            ...
                            <div className="flex bg-white justify-center">
                                <div className="flex w-full mx-1 mb-3 mt-1 justify-center">
                                    <form onSubmit={submit} className="space-y-6 max-w-lg w-full justify-center">
                                        <header className="text-lg font-semibold mb-4 text-center">Zmień dane płatności</header>
                                        <input
                                            type="number"
                                            name="price"
                                            placeholder="Price"
